package com.google.code.codejam._2012.qualificationround;
/**
 * 
 */
 ...
 * 
 */
public class DancingWithTheGooglers extends BaseCommandLineClient {
	...
	public static void main(String[] args) {
    	try {
            new DancingWithTheGooglers().run(args);
            System.exit(0);
    	} catch (Throwable t) {
    		t.printStackTrace();
    		System.exit(1);
